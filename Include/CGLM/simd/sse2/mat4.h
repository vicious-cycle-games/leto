...
#define cglm_mat_sse_h
    ...
    #define glm_mat4_inv_precise_sse2(mat, dest)                          \
...
float glm_mat4_det_sse2(mat4 mat)
{
    ...
    /*
     ...
     t[4] = i * o - m * k;
     */
    x0 = glmm_fnmadd(glmm_shuff1(r3, 0, 0, 1, 1),
    ...
    /*
     ...
     t[5] = i * n - m * j;
     */
    x1 = glmm_fnmadd(glmm_shuff1(r3, 0, 0, 2, 2),
     ...
     */
    x2 = glmm_fnmadd(
        glmm_shuff1(r1, 1, 1, 2, 2), glmm_shuff1(x0, 3, 2, 2, 0),
...
{
    __m128 r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1,
